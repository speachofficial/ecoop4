...
class BiddingItemsItemsSummaryContent extends StatelessWidget {
  const BiddingItemsItemsSummaryContent({super.key});
              ...
              itemBuilder: (BuildContext context, int index) {
                return GridTile(
                  ...
                  decoration: BoxDecoration(
                      border:
                          Border.all(color: AppColors.c333333_100, width: 5.h),
