...
class MainPersonalChatPageContent extends StatefulWidget {
  const MainPersonalChatPageContent({super.key});

  @override
  State<MainPersonalChatPageContent> createState() =>
      _MainPersonalChatPageContentState();
}

class _MainPersonalChatPageContentState
    extends State<MainPersonalChatPageContent> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                Container(
                  ...
                  child: SmallText(text: 'Sun, 15 Feb', size: 32.sp),
                ),
                Align(
                  alignment: Alignment.centerLeft,
                  child: ConstrainedBox(
                    constraints: BoxConstraints(maxWidth: 1150.w),
                    child: Container(
                      margin: EdgeInsets.all(32.h),
